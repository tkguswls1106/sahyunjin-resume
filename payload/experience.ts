      ...
      positions: [
        {
          ...
          descriptions: [
            ...
            },
            {
              ...
              solve: [
                '단일 API 로직을 기능별 4개의 REST API로 분리 후, 분할 로딩화면에 동시 호출해 병렬로 처리',
              ],
              result: [
            ...
            },
            {
              ...
              problem:
                '질병 데이터가 테이블에 2500만개 이상 적재되며, DB의 Read 부하 증대 및 속도 저하',
              solve: [
            ...
            },
            {
              ...
              result: [
                ...
                'Refresh 다중 토큰 운용으로, Access 토큰 탈취 위험에 대한 보안성 향상.',
              ],
            },
            {
...
//                 'Java Spring 기반의 RESTful 서버를 개발, Python Lambda 서버리스 코드의 마이그레이션',
//               result: [
//                 '확장성 높은 모듈화된 백엔드 아키텍처를 구축 → 코드의 재사용성 및 유지보수성 향상',
//               ],
//             },
//             {
//               feature: '메인페이지 로딩 속도 개선',
...
//               result: [
//                 '모든 분석 결과가 로딩될 때까지 30초 이상 접근할 수 없었던 메인페이지를 즉시 이용 가능',
//                 '→ 사용성 향상으로, 첫 화면에서 대기의 부담으로 인한 고객의 이탈도 방지될 것으로 전망',
//               ],
//             },
//             {
//               feature: '질병 기능의 DB 조회 성능 개선 (2500만 데이터)',
...
//                 '기존의 DB 일괄 조회 방식을 60개 단위로 Slice 처리하도록 변경, 무한 스크롤 페이징 적용',
//               result: [
//                 '필터링 API의 응답 속도를 평균 10.52초에서 1.31초로 약 88% 개선',
//                 '→ 수차례 필터링 기준을 변경하며 분석 결과를 확인해야 하는 고객의 경험을 개선',
//               ],
//             },
//             {
//               feature: 'JWT 기반 로그인 시스템 개발',
...
//               result: [
//                 'JWT 내 부여한 계정 권한에 따라, 서버 URI 접근 제한을 손쉽게 설정 가능',
//                 'Refresh 다중 토큰 운용으로, Access 토큰 탈취 위험에 보다 효과적인 대응 가능',
//               ],
//             },
//             {
